...
public:
	...
	*/
	Quaternion operator *=(const Quaternion &multiplier)
	{
		...
		product.r = r * multiplier.r - i * multiplier.i - j * multiplier.j - k * multiplier.k;
		product.i = r * multiplier.i + i * multiplier.r + j * multiplier.k - k * multiplier.j;
		product.j = r * multiplier.j + j * multiplier.r + k * multiplier.i - i * multiplier.k;
		product.k = r * multiplier.k + k * multiplier.r + i * multiplier.j - j * multiplier.i;
